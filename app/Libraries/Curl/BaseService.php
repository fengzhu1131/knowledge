    ...
    public function httpBuilder($path, $data = [], $method = 'GET', $url = '', $extData = [])
    {
        ...
        switch ($method) {
            case self::METHOD_GET:
                $result = self::$httpClient->get($url, $data);
                break;
            case self::METHOD_POST:
                $result = self::$httpClient->post($url, $data);
                break;
            case self::METHOD_PUT:
                $result = self::$httpClient->put($url, $data);
                break;
            case self::METHOD_DELETE:
                $result = self::$httpClient->delete($url, $data);
                break;
            case self::METHOD_POSTFile:
                $result = self::$httpClient->postFile($url, $data, $extData);
                break;
            default:
                $result = self::$httpClient->get($url, $data);
                break;
