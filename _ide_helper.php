 ...
 * Generated for Laravel 5.2.39 on 2017-11-25.
 *
...
namespace App\Libraries\Curl\Facades { 
    ...
    class HttpClientServices {
         ...
         * @static 
         */ 
        public static function getJXTeamStaticJSONList($data, $sip)
        {
            return \App\Libraries\Curl\HttpClientServices::getJXTeamStaticJSONList($data, $sip);
        }
         ...
         * @static 
         */ 
        public static function postMessageToPhone($data, $sip)
        {
            return \App\Libraries\Curl\HttpClientServices::postMessageToPhone($data, $sip);
        }
         ...
         * @static 
         */ 
        public static function getJXStaticJSONList($data, $sip)
        {
            return \App\Libraries\Curl\HttpClientServices::getJXStaticJSONList($data, $sip);
        }
         ...
         * @static 
         */ 
        public static function getJXLiteJSONList($data, $sip)
        {
            return \App\Libraries\Curl\HttpClientServices::getJXLiteJSONList($data, $sip);
        }
         ...
         * @static 
         */ 
        public static function getJXLiteWxLogin($data, $sip)
        {
            return \App\Libraries\Curl\HttpClientServices::getJXLiteWxLogin($data, $sip);
        }
         ...
         * @static 
         */ 
        public static function updateJXLite($data, $sip)
        {
            return \App\Libraries\Curl\HttpClientServices::updateJXLite($data, $sip);
        }
         ...
         * @static 
         */ 
        public static function getJxStaticOfInterface($data)
        {
            return \App\Libraries\Curl\HttpClientServices::getJxStaticOfInterface($data);
        }
         ...
         * @static 
         */ 
        public static function getJxOldOfInterface($data, $face)
        {
            return \App\Libraries\Curl\HttpClientServices::getJxOldOfInterface($data, $face);
        }
         ...
         * @static 
         */ 
        public static function pushVersionMessage($data)
        {
            return \App\Libraries\Curl\HttpClientServices::pushVersionMessage($data);
        }
         ...
         * @static 
         */ 
        public static function getAmrFile($url, $data)
        {
            return \App\Libraries\Curl\HttpClientServices::getAmrFile($url, $data);
        }
         ...
         * @static 
         */ 
        public static function getBookFile($url, $data)
        {
            return \App\Libraries\Curl\HttpClientServices::getBookFile($url, $data);
        }
         ...
         * @static 
         */ 
        public static function getMethod($url, $data, $method = 'GET')
        {
            return \App\Libraries\Curl\HttpClientServices::getMethod($url, $data, $method);
        }
        ...
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::getConfig();
        }
         ...
         * @static 
         */ 
        public static function parseRestfulUIR($uri, $params)
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::parseRestfulUIR($uri, $params);
        }
         ...
         * @static 
         */ 
        public static function httpBuilder($path, $data = array(), $method = 'GET', $url = '', $extData = array())
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::httpBuilder($path, $data, $method, $url, $extData);
        }
        ...
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::init();
        }
        ...
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::get($url, $data);
        }
        ...
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::put($url, $data);
        }
        ...
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::delete($url, $data);
        }
         ...
         * @static 
         */ 
        public static function postFile($url, $fileData, $extData = array())
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::postFile($url, $fileData, $extData);
        }
        ...
        {
            //Method inherited from \App\Libraries\Curl\BaseService            
            return \App\Libraries\Curl\HttpClientServices::post($url, $data);
        }
...
namespace App\Libraries\Weixin\Facades { 
    ...
    class WeixinServices {
         ...
         * @static 
         */ 
        public static function setCurl($u)
        {
            return \App\Libraries\Weixin\WeixinServices::setCurl($u);
        }
        ...
        {
            return \App\Libraries\Weixin\WeixinServices::getAppId();
        }
        ...
        {
            return \App\Libraries\Weixin\WeixinServices::getAppSecret();
        }
         ...
         * @static 
         */ 
        public static function getSignPackage($sul)
        {
            return \App\Libraries\Weixin\WeixinServices::getSignPackage($sul);
        }
         ...
         * @param \App\Libraries\Weixin\{$length}  随机字符串长度，默认16位
         * @static 
         */ 
        public static function createNonceStr($length = 16)
        {
            return \App\Libraries\Weixin\WeixinServices::createNonceStr($length);
        }
        ...
        {
            return \App\Libraries\Weixin\WeixinServices::getAccessToken();
        }
         ...
         * @static 
         */ 
        public static function get_lotteryinfo($parameters_addlotteryinfo)
        {
            return \App\Libraries\Weixin\WeixinServices::get_lotteryinfo($parameters_addlotteryinfo);
        }
        
        /**
         * 获取授权AccessToken信息
         *
         * @param \App\Libraries\Weixin\{String}  code 授权页面返回的code编码，授权通过时才有，不通过是没有
         * @return \App\Libraries\Weixin\{Object} {
         ...
         * @static 
         */ 
        public static function getAuthorizeAccessToken($code)
        {
            return \App\Libraries\Weixin\WeixinServices::getAuthorizeAccessToken($code);
        }
         ...
         * @static 
         */ 
        public static function getUserInfoByOpenid($access_token, $openid)
        {
            return \App\Libraries\Weixin\WeixinServices::getUserInfoByOpenid($access_token, $openid);
        }
         ...
         * @static 
         */ 
        public static function getUserBaseInfo($openid)
        {
            return \App\Libraries\Weixin\WeixinServices::getUserBaseInfo($openid);
        }
         ...
         * @static 
         */ 
        public static function getAuthorizeToken($code, $k = '')
        {
            return \App\Libraries\Weixin\WeixinServices::getAuthorizeToken($code, $k);
        }
        ...
        public static function getConfig()
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::getConfig();
        }
        ...
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::parseRestfulUIR($uri, $params);
        }
        ...
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::httpBuilder($path, $data, $method, $url, $extData);
        }
        ...
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::init();
        }
        ...
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::get($url, $data);
        }
        ...
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::put($url, $data);
        }
        ...
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::delete($url, $data);
        }
        ...
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::postFile($url, $fileData, $extData);
        }
        ...
        {
            //Method inherited from \App\Libraries\Weixin\BaseService            
            return \App\Libraries\Weixin\WeixinServices::post($url, $data);
        }
...
namespace App\Libraries\Share\Facades { 
    ...
    class ShareServices {
         ...
         * @static 
         */ 
        public static function saveAmrToMp4($audioUrl, $param, $file)
        {
            return \App\Libraries\Share\ShareServices::saveAmrToMp4($audioUrl, $param, $file);
        }
         ...
         * @static 
         */ 
        public static function video_info($file, $ffmpeg)
        {
            return \App\Libraries\Share\ShareServices::video_info($file, $ffmpeg);
        }
         ...
         * @static 
         */ 
        public static function setLogOfBrowerEnvironment($shareid)
        {
            return \App\Libraries\Share\ShareServices::setLogOfBrowerEnvironment($shareid);
        }
         ...
         * @static 
         */ 
        public static function setSession($key, $value, $merge = true)
        {
            return \App\Libraries\Share\ShareServices::setSession($key, $value, $merge);
        }
         ...
         * @static 
         */ 
        public static function checkIsUpdateGroupViewCnt($shareid)
        {
            return \App\Libraries\Share\ShareServices::checkIsUpdateGroupViewCnt($shareid);
        }
         ...
         * @static 
         */ 
        public static function getAllJxLinkShareID($data)
        {
            return \App\Libraries\Share\ShareServices::getAllJxLinkShareID($data);
        }
         ...
         * @static 
         */ 
        public static function getWxShareFirstImg($data)
        {
            return \App\Libraries\Share\ShareServices::getWxShareFirstImg($data);
        }
         ...
         * @static 
         */ 
        public static function getShareDescription($data)
        {
            return \App\Libraries\Share\ShareServices::getShareDescription($data);
        }
         ...
         * @static 
         */ 
        public static function getBottomAbbImg($data)
        {
            return \App\Libraries\Share\ShareServices::getBottomAbbImg($data);
        }
         ...
         * @static 
         */ 
        public static function getLinkHasNewNotes($shModel, $shareid, $last)
        {
            return \App\Libraries\Share\ShareServices::getLinkHasNewNotes($shModel, $shareid, $last);
        }
         ...
         * @static 
         */ 
        public static function checkExitUser($wxUser, $user)
        {
            return \App\Libraries\Share\ShareServices::checkExitUser($wxUser, $user);
        }
        
        /**
         * 校验用户是否已经微信登录
         *
         * @param \App\Libraries\Share\{Object} $model 微信用户表
         * @param \App\Libraries\Share\{String} $userid 用户ID
         * @return \App\Libraries\Share\{bool} 是否已经微信登录
         * @static 
         */ 
        public static function chekUserHasWxLogin($model, $userid)
        {
            return \App\Libraries\Share\ShareServices::chekUserHasWxLogin($model, $userid);
        }
         ...
         * @static 
         */ 
        public static function getJXStaticJSONList($model, $serverip, $userid, $start, $end, $type, $title)
        {
            return \App\Libraries\Share\ShareServices::getJXStaticJSONList($model, $serverip, $userid, $start, $end, $type, $title);
        }
         ...
         * @static 
         */ 
        public static function updateGroupViewCnt($shareHistory, $logModel, $userid, $username, $share_title, $env)
        {
            return \App\Libraries\Share\ShareServices::updateGroupViewCnt($shareHistory, $logModel, $userid, $username, $share_title, $env);
        }
         ...
         * @static 
         */ 
        public static function getShareHistory($shModel, $shareid)
        {
            return \App\Libraries\Share\ShareServices::getShareHistory($shModel, $shareid);
        }
         ...
         *
         * @param $len 随机字符串长度
         * @param $type 随机字符串类型,0:全不字符[大小写字母数字],1:小写字母,2:大写字母,3:数字
         * @param $format 格式化格式
         * @param $prefix 前缀
         * @param $suffix 后缀
         * @static 
         */ 
        public static function getRandomStr($len = 16, $type = 0, $format = '', $prefix = '', $suffix = '')
        {
            return \App\Libraries\Share\ShareServices::getRandomStr($len, $type, $format, $prefix, $suffix);
        }
         ...
         * @static 
         */ 
        public static function getWeixinConfig()
        {
            return \App\Libraries\Share\ShareServices::getWeixinConfig();
        }
         ...
         * @static 
         */ 
        public static function setComplaintData($complaintModel)
        {
            return \App\Libraries\Share\ShareServices::setComplaintData($complaintModel);
        }
         ...
         * @static 
         */ 
        public static function addRecordOfComment($shModel, $recModel, $shareid, $content)
        {
            return \App\Libraries\Share\ShareServices::addRecordOfComment($shModel, $recModel, $shareid, $content);
        }
        
        /**
         * 添加点赞或评论,点赞认为是一种特殊的评论
         *
         * @param \App\Libraries\Share\{String} $shareid 分享ID
         * @static 
         */ 
        public static function setComment($shModel, $recModel, $model, $shareid)
        {
            return \App\Libraries\Share\ShareServices::setComment($shModel, $recModel, $model, $shareid);
        }
         ...
         * @static 
         */ 
        public static function delComments($model, $shareid)
        {
            return \App\Libraries\Share\ShareServices::delComments($model, $shareid);
        }
         ...
         * @static 
         */ 
        public static function getComments($model, $shareid)
        {
            return \App\Libraries\Share\ShareServices::getComments($model, $shareid);
        }
         ...
         * @static 
         */ 
        public static function getLikeCount($model, $shareid)
        {
            return \App\Libraries\Share\ShareServices::getLikeCount($model, $shareid);
        }
         ...
         * @static 
         */ 
        public static function getUserComments($model, $userid)
        {
            return \App\Libraries\Share\ShareServices::getUserComments($model, $userid);
        }
         ...
         * @static 
         */ 
        public static function getUserLikeCounts($model, $userid)
        {
            return \App\Libraries\Share\ShareServices::getUserLikeCounts($model, $userid);
        }
         ...
         * @static 
         */ 
        public static function getWeixinConfigByKey($key)
        {
            return \App\Libraries\Share\ShareServices::getWeixinConfigByKey($key);
        }
         ...
         * @static 
         */ 
        public static function getShareDesc($type, $shareDesc)
        {
            return \App\Libraries\Share\ShareServices::getShareDesc($type, $shareDesc);
        }
         ...
         * @static 
         */ 
        public static function getAnimationCss($viewtype)
        {
            return \App\Libraries\Share\ShareServices::getAnimationCss($viewtype);
        }
        
        /**
         * 获取用户底部图片，目前直接根据公司名称使用固定配置
         *
         * @static 
         */ 
        public static function getUserBottomImages($user)
        {
            return \App\Libraries\Share\ShareServices::getUserBottomImages($user);
        }
        
        /**
         * 获取记录列表
         *
         * @param \App\Libraries\Share\{Object} $model 查询对象
         * @param \App\Libraries\Share\{Object} $shareHistoryModel 分享对象
         * @param \App\Libraries\Share\{String} $shareid 分享ID
         * @param \App\Libraries\Share\{Object} $logModel 日志表对象
         * @static 
         */ 
        public static function getNotesList($model, $shareHistoryModel, $shareid, $logModel, $username, $env)
        {
            return \App\Libraries\Share\ShareServices::getNotesList($model, $shareHistoryModel, $shareid, $logModel, $username, $env);
        }
         ...
         * @static 
         */ 
        public static function getViewUrlByType($type, $folder)
        {
            return \App\Libraries\Share\ShareServices::getViewUrlByType($type, $folder);
        }
         ...
         * @static 
         */ 
        public static function getUrlByModel($viewtpe)
        {
            return \App\Libraries\Share\ShareServices::getUrlByModel($viewtpe);
        }
         ...
         * @static 
         */ 
        public static function getUrlByKeyWords($group_name)
        {
            return \App\Libraries\Share\ShareServices::getUrlByKeyWords($group_name);
        }
         ...
         * @static 
         */ 
        public static function getOSSAbbImageUrl($image)
        {
            return \App\Libraries\Share\ShareServices::getOSSAbbImageUrl($image);
        }
         ...
         * @static 
         */ 
        public static function getTeamStaticDataList($data, $env)
        {
            return \App\Libraries\Share\ShareServices::getTeamStaticDataList($data, $env);
        }
         ...
         * @static 
         */ 
        public static function postMessageToPhone($data, $env)
        {
            return \App\Libraries\Share\ShareServices::postMessageToPhone($data, $env);
        }
        
        /**
         * 下载文件
         *
         * @param \App\Libraries\Share\{String} $url 下载文件路径
         * @param \App\Libraries\Share\{String} $newFileName 下载文件名称,用于显示下载重命名
         * @param \App\Libraries\Share\{String} $fileSize 下载文件大小
         * @return \response 文件二进制流
         * @static 
         */ 
        public static function exportOrDown($url, $newFileName, $fileSize)
        {
            return \App\Libraries\Share\ShareServices::exportOrDown($url, $newFileName, $fileSize);
        }
         ...
         * @static 
         */ 
        public static function updateShareBottomImageClickCnt($model, $logModel, $shareid)
        {
            return \App\Libraries\Share\ShareServices::updateShareBottomImageClickCnt($model, $logModel, $shareid);
        }
        ...
        {
            return \App\Libraries\Share\ShareServices::is_weixin();
        }
        ...
        public static function init()
        {
            //Method inherited from \App\Libraries\Share\BaseService            
            return \App\Libraries\Share\ShareServices::init();
        }
...
namespace App\Libraries\Helplib\Facades { 
    ...
    class HelpLibServices {
        
        /**
         * 获取浏览器分析对象
         *
         * @return \App\Libraries\Helplib\{Class} AnalysisBrowser
         * @static 
         */ 
        public static function getAnalysisBrowser()
        {
            return \App\Libraries\Helplib\HelpLibServices::getAnalysisBrowser();
        }
        
        /**
         * 获取错误信息对象
         *
         * @return \App\Libraries\Helplib\{Class} AppConfig
         * @static 
         */ 
        public static function getAppConfig()
        {
            return \App\Libraries\Helplib\HelpLibServices::getAppConfig();
        }
         ...
         * @static 
         */ 
        public static function checkTextIsUrl($text)
        {
            return \App\Libraries\Helplib\HelpLibServices::checkTextIsUrl($text);
        }
        ...
        {
            return \App\Libraries\Helplib\HelpLibServices::getUrlData($url);
        }
        ...
        public static function getConfig()
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::getConfig();
        }
        ...
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::parseRestfulUIR($uri, $params);
        }
        ...
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::httpBuilder($path, $data, $method, $url, $extData);
        }
        ...
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::init();
        }
        ...
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::get($url, $data);
        }
        ...
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::put($url, $data);
        }
        ...
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::delete($url, $data);
        }
        ...
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::postFile($url, $fileData, $extData);
        }
        ...
        {
            //Method inherited from \App\Libraries\Helplib\BaseService            
            return \App\Libraries\Helplib\HelpLibServices::post($url, $data);
        }
...
namespace  { 
    ...
    class HttpClient extends \App\Libraries\Curl\Facades\HttpClientServices {}

    class Weixin extends \App\Libraries\Weixin\Facades\WeixinServices {}

    class Share extends \App\Libraries\Share\Facades\ShareServices {}

    class Helplib extends \App\Libraries\Helplib\Facades\HelpLibServices {}
